	...
	public static void main(String[] args) {
		...
		do {
			...
			case 1:
				...
				c.add(new AddressBookUC4(firstName, lastName, address, state, zip, phoneNumber, eMail));
				break;
			case 2:
				Iterator<AddressBookUC4> i = c.iterator();
				while(i.hasNext()) {
					AddressBookUC4 e = i.next();
			...
			case 3:
				...
				ListIterator<AddressBookUC4> li = ((ArrayList<AddressBookUC4>) c).listIterator();
				while(li.hasNext()) {
					AddressBookUC4 e = li.next();
					if(e.getPhoneNumber() == phoneNumber) {
						...
						eMail = scan.nextLine();
						li.set(new AddressBookUC4(firstName, lastName , address, state, zip, phoneNumber, eMail));
						found = true;
					}
				}
				if(!found) {
