...
public class AddressBook6 {
	public static void main(String[] args) {
		...
		Collection<AddressBookUC6> c1 = new ArrayList<AddressBookUC6>();
		...
		do {
			...
			case 1:
				...
				if(opt == 1) {
					c.add(new AddressBookUC6(firstName, lastName, address, state, zip, phoneNumber, eMail));
				}
				if(opt == 2) {
					c1.add(new AddressBookUC6(firstName, lastName, address, state, zip, phoneNumber, eMail));
				}
				break;
			case 2:
				System.out.print("1.Book_1 \n2.Book_2 \nChoose the Address Book : ");
				...
				if(opt == 1) {
					...
					while(i.hasNext()) {
						AddressBookUC6 e = i.next();
						System.out.println(e);
					}
				}
				if(opt == 2) {
					Iterator<AddressBookUC6> i = c1.iterator();
					while(i.hasNext()) {
						AddressBookUC6 e = i.next();
						System.out.println(e);
					}
			...
			case 3:
				...
				if(opt == 1) {
					...
					ListIterator<AddressBookUC6> li =  ((ArrayList<AddressBookUC6>) c).listIterator();
					while(li.hasNext()) {
						AddressBookUC6 e = li.next();
						if(e.getPhoneNumber() == phoneNumber) {
							...
							eMail = scan.nextLine();
							System.out.print("1.Book_1 \n 2.Book_2 \n Choose the Address Book : ");
							li.set(new AddressBookUC6(firstName, lastName , address, state, zip, phoneNumber, eMail));
							found = true;
						}
					}
				}
				if(opt == 2) {
					System.out.print("Enter the Phone Number to Edit the contact: ");
					phoneNumber =  scan1.nextLong();
					ListIterator<AddressBookUC6> li =  ((ArrayList<AddressBookUC6>) c1).listIterator();
					while(li.hasNext()) {
						AddressBookUC6 e = li.next();
						if(e.getPhoneNumber() == phoneNumber) {
							System.out.print("Enter new First Name : ");
